<?php
/**
 * MySQLi PDO Database Class
 *
 * Extension from the base PDO class
 *
 * @package		Framework
...
class db_pdo extends PDO {
    ...
    /**
     * @param String All catchable errors are stored here
     */
    private $error = '';
    private $sql   = '';
    private $bind  = '';
    ...
    public function select($table, $where = "", $bind = "", $join = '', $fields = "*", $order = '')
    {
    ...
    private function cleanup($bind)
    {
        if(!is_array($bind))
        {
            $bind = (!empty($bind)) ? $bind = array($bind) : $bind = array();
        }
